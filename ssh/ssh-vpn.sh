...
wget -O /etc/nginx/nginx.conf "https://github.com/petualangz/AI/edit/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/petualangz/AI/edit/main/ssh/newudpgw"
